                        ...
                        <div class="item_right">
                            <div class="item_right_img">
                                ...
                                <div class="item_right_img_bottom">
                                    <div class="item_right_img_bottom_item"> <img src="@/assets/Search/phone01.png"
                                            alt="测试图片"></div>
                                    <div class="item_right_img_bottom_item"> <img src="@/assets/Search/phone01.png"
                                            alt="测试图片"></div>
                                    <div class="item_right_img_bottom_item"> <img src="@/assets/Search/phone01.png"
        ...
        <div class="search_deatil">
            <div class="search_detail_list">
                <div class="search_detail_list_top">
                    <div class="search_detail_list_top_item">
                        ...
                        <div class="description">Apple苹果iPhone 6s (A1699)Apple苹果iPhone 6s (A1699)Apple苹果iPhone 6s
                            (A1699)Apple苹果iPhone 6s (A1699)</div>
                        <div class="judge">
                            已有
            ...
            <div class="demo-pagination-block">
                <el-pagination v-model:current-page="currentPageNumber" :page-size="10" :small="false" :disabled="false"
                    :background="false" layout="total, prev, pager, next" :total="1000" @size-change="handleSizeChange"
